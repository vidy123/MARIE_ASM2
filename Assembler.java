...
/* --                                                                                 -- */
  ...
  public static final int COMMENT_DELIM = (int) '/';   // Punctuation for inline commentss.
...
/* --                                                                                 -- */
                                     ...
                                     // retrieve values.
  // BMM FIX unchecked call to put(K,V) 
  public Hashtable<String,SymbolEntry> symbolTable                    // Initial capacity 18, load factor 0.75.
                           = new Hashtable<String,SymbolEntry>(18, (float) 0.75);
  // BMM FIX unchecked call to put(K,V)        
  public final Hashtable<String, Instruction> instructionSet = new Hashtable<String, Instruction>(18);
  ...
  public ArrayList<String> errorList = new ArrayList<String>();   // Holds text of any errors found.
...
/* ------------------------------------------------------------------------------------- */
/* -- Mainline processing. moved to Main.java                                         -- */
/* ------------------------------------------------------------------------------------- */
...
******************************************************************************************/
  ...
  // BMM NOTE: generic Exception instead of FileNotFound
  catch (IOException e) {
    System.err.println(lineFeed+"File " + sourceFileName + "."+sourceType+" not found.");
    errorFound = true;
    return;
  } // catch
  //BMM NOTE: compiler warning ?
  //catch (IOException e) {
